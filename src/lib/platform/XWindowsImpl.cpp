...
int XWindowsImpl::XGetKeyboardControl(Display* display, XKeyboardState* value_return)
{
...
int XWindowsImpl::XSetInputFocus(Display* display, Window focus, int revert_to, Time time)
{
    return ::XSetInputFocus(display, focus, revert_to, time);
}

Bool XWindowsImpl::DPMSQueryExtension(Display* display, int* event_base, int* error_base)
{
...
Status XWindowsImpl::DPMSInfo(Display* display, CARD16* power_level, BOOL* state)
{
...
int XWindowsImpl::XGetInputFocus(Display* display, Window* focus_return, int* revert_to_return)
{
...
Bool XWindowsImpl::XQueryPointer(Display* display, Window w, Window* root_return,
                                 Window* child_return, int* root_x_return, int* root_y_return,
                                 int* win_x_return, int* win_y_return, unsigned int* mask_return)
{
    return ::XQueryPointer(display, w, root_return, child_return, root_x_return, root_y_return,
...
Bool XWindowsImpl::XCheckMaskEvent(Display* display, long event_mask, XEvent* event_return)
{
...
int XWindowsImpl::XGrabKey(Display* display, int keycode, unsigned int modifiers,
                           Window grab_window, int owner_events, int pointer_made,
                           int keyboard_mode)
{
    return ::XGrabKey(display, keycode, modifiers, grab_window, owner_events, pointer_made,
                      keyboard_mode);
}
...
int XWindowsImpl::XUngrabKey(Display* display, int keycode, unsigned int modifiers,
                             Window grab_window)
{
    return ::XUngrabKey(display, keycode, modifiers, grab_window);
}

int XWindowsImpl::XTestFakeButtonEvent(Display* display, unsigned int button, int is_press,
                                       unsigned long delay)
{
...
int XWindowsImpl::XWarpPointer(Display* display, Window src_w, Window dest_w, int src_x, int src_y,
                               unsigned int src_width, unsigned int src_height, int dest_x,
                               int dest_y)
{
    return ::XWarpPointer(display, src_w, dest_w, src_x, src_y, src_width, src_height, dest_x,
                          dest_y);
}

int XWindowsImpl::XTestFakeRelativeMotionEvent(Display* display, int x, int y, unsigned long delay)
{
...
int XWindowsImpl::XTestFakeKeyEvent(Display* display, unsigned int keycode, int is_press,
                                    unsigned long delay)
{
...
Bool XWindowsImpl::XQueryExtension(Display* display, const char* name, int* major_opcode_return,
                                   int* first_event_return, int* first_error_return)
{
    return ::XQueryExtension(display, name, major_opcode_return, first_event_return,
                             first_error_return);
}
...
Bool XWindowsImpl::XkbQueryExtension(Display* display, int* opcodeReturn, int* eventBaseReturn,
                                     int* errorBaseReturn, int* majorRtrn, int* minorRtrn)
{
    return ::XkbQueryExtension(display, opcodeReturn, eventBaseReturn, errorBaseReturn, majorRtrn,
                               minorRtrn);
}

Bool XWindowsImpl::XkbSelectEvents(Display* display, unsigned int deviceID, unsigned int affect,
                                   unsigned int values)
{
...
Bool XWindowsImpl::XineramaQueryExtension(Display* display, int* event_base, int* error_base)
{
...
Window XWindowsImpl::XCreateWindow(Display* display, Window parent, int x, int y,
                                   ...
                                   unsigned int border_width, int depth, unsigned int klass,
                                   Visual* visual, unsigned long valuemask,
                                   XSetWindowAttributes* attributes)
{
    return ::XCreateWindow(display, parent, x, y, width, height, border_width, depth, klass, visual,
                           valuemask, attributes);
}

XIM XWindowsImpl::XOpenIM(Display* display, _XrmHashBucketRec* rdb, char* res_name, char* res_class)
{
...
XIC XWindowsImpl::XCreateIC(XIM im, const char* type1, unsigned long data, const char* type2,
                            unsigned long data2)
{
...
Status XWindowsImpl::XGetWindowAttributes(Display* display, Window w, XWindowAttributes* attrs)
{
...
Bool XWindowsImpl::XGetEventData(Display* display, XGenericEventCookie* cookie)
{
    return ::XGetEventData(display, cookie);
}

void XWindowsImpl::XFreeEventData(Display* display, XGenericEventCookie* cookie)
{
...
int XWindowsImpl::XResizeWindow(Display* display, Window w, unsigned int width, unsigned int height)
{
    return ::XResizeWindow(display, w, width, height);
}

int XWindowsImpl::XMaskEvent(Display* display, long event_mask, XEvent* event_return)
{
    return ::XMaskEvent(display, event_mask, event_return);
}

Status XWindowsImpl::XQueryBestCursor(Display* display, Drawable d, unsigned int width,
...
Pixmap XWindowsImpl::XCreateBitmapFromData(Display* display, Drawable d, const char* data,
                                           unsigned int width, unsigned int height)
{
    return ::XCreateBitmapFromData(display, d, data, width, height);
}

Cursor XWindowsImpl::XCreatePixmapCursor(Display* display, Pixmap source, Pixmap mask,
...
int XWindowsImpl::XmbLookupString(XIC ic, XKeyPressedEvent* event, char* buffer_return,
                                  int bytes_buffer, KeySym* keysym_return, int* status_return)
{
    return ::XmbLookupString(ic, event, buffer_return, bytes_buffer, keysym_return, status_return);
}

int XWindowsImpl::XLookupString(XKeyEvent* event_struct, char* buffer_return, int bytes_buffer,
                                KeySym* keysym_return, XComposeStatus* status_in_out)
{
    return ::XLookupString(event_struct, buffer_return, bytes_buffer, keysym_return, status_in_out);
}

Status XWindowsImpl::XSendEvent(Display* display, Window w, Bool propagate, long event_mask,
                                XEvent* event_send)
{
...
int XWindowsImpl::XGetPointerMapping(Display* display, unsigned char* map_return, int nmap)
{
    return ::XGetPointerMapping(display, map_return, nmap);
}

int XWindowsImpl::XGrabKeyboard(Display* display, Window grab_window, Bool owner_events,
...
int XWindowsImpl::XGrabPointer(Display* display, Window grab_window, Bool owner_events,
                               unsigned int event_mask, int pointer_mode, int keyboard_mode,
                               Window confine_to, Cursor cursor, Time time)
{
    return ::XGrabPointer(display, grab_window, owner_events, event_mask, pointer_mode,
...
int XWindowsImpl::XISelectEvents(Display* display, Window w, XIEventMask* masks, int num_masks)
{
    return ::XISelectEvents(display, w, masks, num_masks);
}

Atom XWindowsImpl::XInternAtom(Display* display, _Xconst char* atom_name, Bool only_if_exists)
{
    return ::XInternAtom(display, atom_name, only_if_exists);
}

int XWindowsImpl::XGetScreenSaver(Display* display, int* timeout_return, int* interval_return,
                                  int* prefer_blanking_return, int* allow_exposures_return)
{
    return ::XGetScreenSaver(display, timeout_return, interval_return, prefer_blanking_return,
                             allow_exposures_return);
}

int XWindowsImpl::XSetScreenSaver(Display* display, int timeout, int interval, int prefer_blanking,
                                  int allow_exposures)
{
    return ::XSetScreenSaver(display, timeout, interval, prefer_blanking, allow_exposures);
}
...
int XWindowsImpl::XSetSelectionOwner(Display* display, Atom selection, Window w, Time time)
{
...
Atom* XWindowsImpl::XListProperties(Display* display, Window w, int* num_prop_return)
{
...
void XWindowsImpl::XkbFreeKeyboard(XkbDescPtr xkb, unsigned int which, Bool freeDesc)
{
    ::XkbFreeKeyboard(xkb, which, freeDesc);
}

XkbDescPtr XWindowsImpl::XkbGetMap(Display* display, unsigned int which, unsigned int deviceSpec)
{
    return ::XkbGetMap(display, which, deviceSpec);
}

Status XWindowsImpl::XkbGetState(Display* display, unsigned int deviceSet, XkbStatePtr rtrnState)
{
...
Status XWindowsImpl::XkbGetUpdatedMap(Display* display, unsigned int which, XkbDescPtr desc)
{
    return ::XkbGetUpdatedMap(display, which, desc);
}

Bool XWindowsImpl::XkbLockGroup(Display* display, unsigned int deviceSpec, unsigned int group)
{
...
KeySym* XWindowsImpl::XGetKeyboardMapping(Display* display, unsigned int first_keycode,
...
XkbKeyTypePtr XWindowsImpl::do_XkbKeyKeyType(XkbDescPtr m_xkb, KeyCode keycode, int eGroup)
{
    return XkbKeyKeyType(m_xkb, keycode, eGroup);
}

KeySym XWindowsImpl::do_XkbKeySymEntry(XkbDescPtr m_xkb, KeyCode keycode, int level, int eGroup)
{
...
XkbAction* XWindowsImpl::do_XkbKeyActionEntry(XkbDescPtr m_xkb, KeyCode keycode, int level,
                                              int eGroup)
{
    return XkbKeyActionEntry(m_xkb, keycode, level, eGroup);
}

unsigned char XWindowsImpl::do_XkbKeyGroupInfo(XkbDescPtr m_xkb, KeyCode keycode)
{
