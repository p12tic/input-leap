...
void MSWindowsKeyState::fakeKeyDown(KeyID id, KeyModifierMask mask, KeyButton button)
{
...
void MSWindowsKeyState::getKeyMap(inputleap::KeyMap& keyMap)
{
...
KeyID MSWindowsKeyState::getIDForKey(inputleap::KeyMap::KeyItem& item, KeyButton button,
                                     UINT virtualKey, PBYTE keyState, HKL hkl) const
{
    ...
    case -1: {
        ...
        BYTE emptyState[256] = {};
        n = m_ToUnicodeEx(VK_SPACE, 0, emptyState, unicode, sizeof(unicode) / sizeof(unicode[0]), 0,
                          hkl);
...
void MSWindowsKeyState::addKeyEntry(inputleap::KeyMap& keyMap, inputleap::KeyMap::KeyItem& item)
{
